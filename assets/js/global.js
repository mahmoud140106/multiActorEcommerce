      ...
      navLinks.innerHTML = `
        ...
        <li class="nav-item">
          <a class="nav-link hover-light" href="/customer/wishlist.html" title="Wishlist">
            ...
            <span class="badge badge-notification rounded-pill bg-danger">${wishlistCount > 0 ? wishlistCount : ''}</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link hover-light" href="/customer/cart.html" title="Cart">
            ...
            <span class="badge badge-notification rounded-pill bg-danger">${cartCount > 0 ? cartCount : ''}</span>
          </a>
        </li>
        ${profileLink}
        ${logoutLink}
